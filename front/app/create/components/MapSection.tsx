  ...
  return (
    ...
    >
      ...
      <svg
        ...
        viewBox={selectedPrefecture === "1" ? "602 10 407 287" : "0 0 1400 900"}
      ...
      >
        ...
        <g
          className="svg-map"
          transform={
            selectedPrefecture === "1"
              ? "matrix(1, 0, 0, 1, 0, 0)"
              : "matrix(1.028807, 0, 0, 1.028807, 200, -100) rotate(15, 500, 500)"
          }
        >
          <g className="prefectures" transform="matrix(1, 0, 0, 1, 6, 18)">
            {selectedPrefecture === "1" ? (
              ...
              <g
                ...
                onClick={() => handlePrefectureClick(null)}
              >
              ...
              <>
                ...
                <g
                  className="mie kinki prefecture"
                  data-code="24"
                  stroke-linejoin="round"
                  fill="#EEEEEE"
                  fill-rule="nonzero"
